...
/**
 *
 * @author mfaour public class Camion implements Serializable
 */
public class Camion implements Serializable {
    ...
    public Camion(Coordonnees coordonnees, Deplacement deplacement, String flightName) {
    ...
    public String getInfo() {
        String info = "Matricule:" + _flightName + ", " 
